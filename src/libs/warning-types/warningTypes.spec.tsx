...
describe('Show Plan Period', () => {
  it('return "green"', () => {
    ...
    expect(text).toBe('text-green-500');
  ...
  it('return "secondary"', () => {
    ...
    expect(text).toBe('text-secondary-500');
  ...
  it('return "blue"', () => {
    ...
    expect(text).toBe('text-blue-500');
  ...
  it('return "primary"', () => {
    ...
    expect(text).toBe('text-primary-500');
